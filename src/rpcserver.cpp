...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"blockchain", "getblockval", &getblockhash, true, false, false},
        ...
        /* Beacon features */
        {"beacon", "masternode", &masternode, true, true, false},
        ...
        {"beacon", "mnbudget", &mnbudget, true, true, false},
...
#ifdef ENABLE_WALLET
        {"beacon", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use beacond, or the -server option to beacon-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"Beacon Alert\" admin@foo.com\n"),
